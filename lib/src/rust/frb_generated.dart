...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 85984219;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiBridgeConnectionClose({
    required QuicConnection connection,
  ...
  Future<QuicEndpoint> crateApiBridgeCreateClientEndpointWithCert({
  ...
  Future<void> crateApiBridgeEndpointClose({
  ...
  Future<QuicEndpoint> crateApiBridgeEndpointWaitIdle({
    required QuicEndpoint endpoint,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiBridgeConnectionClose({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiBridgeConnectionCloseConstMeta,
        argValues: [connection, errorCode, reason],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiBridgeConnectionCloseConstMeta =>
      const TaskConstMeta(
        debugName: "connection_close",
        argNames: ["connection", "errorCode", "reason"],
      );
  ...
  Future<QuicEndpoint> crateApiBridgeCreateClientEndpointWithCert({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_list_list_prim_u_8_strict(caRoots, serializer);
          sse_encode_list_list_prim_u_8_strict(certChain, serializer);
          sse_encode_list_prim_u_8_loose(clientKey, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 22,
        ...
        constMeta: kCrateApiBridgeCreateClientEndpointWithCertConstMeta,
        argValues: [caRoots, certChain, clientKey],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiBridgeCreateClientEndpointWithCertConstMeta =>
      const TaskConstMeta(
        debugName: "create_client_endpoint_with_cert",
        argNames: ["caRoots", "certChain", "clientKey"],
      );
  ...
  Future<void> crateApiBridgeEndpointClose({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiBridgeEndpointCloseConstMeta,
        argValues: [endpoint, errorCode, reason],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiBridgeEndpointCloseConstMeta =>
      const TaskConstMeta(
        debugName: "endpoint_close",
        argNames: ["endpoint", "errorCode", "reason"],
      );
  ...
  Future<QuicEndpoint> crateApiBridgeEndpointWaitIdle({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiBridgeEndpointWaitIdleConstMeta,
        argValues: [endpoint],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiBridgeEndpointWaitIdleConstMeta =>
      const TaskConstMeta(
        debugName: "endpoint_wait_idle",
        argNames: ["endpoint"],
      );
